CRUD_hometwo = {};
DSON.keepmerge(CRUD_hometwo, CRUDDEFAULTS);
DSON.keepmerge(CRUD_hometwo, {
    table: {
        //width: "width:3000px;",
        //view: 'vw_vw_cargo',
        //method: 'vw_cargo',
...
//CRUD_hometwo.table.options[0].menus[0].show = function (data) {
//  return data.row.id > 5;
//};
//add options example, remember add new item in allow object at admin/0-config/security/permission.json
// CRUD_hometwo.table.options[0].menus.push({
//     text: (data) => {
