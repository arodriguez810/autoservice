STORAGE = {
    run: function ($scope) {
        ...
        $scope.clearModel = function () {
            for (var key in localStorage) {
                if (key.indexOf(CONFIG.version.app + $scope.modelName + ".") !== -1) {
    ...
    delete: function (id) {
        localStorage.removeItem(CONFIG.version.app + id);
    },
    add: function (id, object) {
        STORAGE.delete(id);
        localStorage.setItem(CONFIG.version.app + id, JSON.stringify(object));
    },
    get: function (id) {
        if (localStorage.getItem(CONFIG.version.app + id) === null) return null;
        return eval("(" + localStorage.getItem(CONFIG.version.app + id) + ")");
    },
    getSimple: function (id) {
        if (localStorage.getItem(CONFIG.version.app + id) === null) return null;
        return localStorage.getItem(CONFIG.version.app + id);
    },
    exist: function (id) {
        return localStorage.getItem(CONFIG.version.app + id) !== null;
    },
